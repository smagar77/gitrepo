...
from twitter_utils import consumer, get_request_token,get_oauth_verifier, get_access_token, get_oauth_verifier_url
from user import User
from database import Database
import requests, json
app = Flask(__name__)
app.secret_key = '1234'
Database.initialise(user="pgadmin", password="tiger", host="localhost", database="learning")
...
def search(): #https://api.twitter.com/1.1/search/tweets.json?q=@sachin_rt+filter:images
    #query = request.args.post('q')
